...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210127_woocommerce_6fbc7a0b201232b74822_20210315102946_archive.zip';
	const ARCHIVE_SIZE		 = '34996904';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6fbc7a0-15102946';
    const SECONDARY_PACKAGE_HASH = 'f4214f0-15102946';
