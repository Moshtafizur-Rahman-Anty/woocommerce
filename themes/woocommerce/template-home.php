    ...
    <main>
        ...
        <section class="slider">
            ...
            <div class="flexslider">
                  <ul class="slides">
                   ...
                   ?>
                        <li>
                        <?php the_post_thumbnail('theme-name-slider', array('class' => 'img-fluid'));?>
                           
                        <div class="container">
                            <div class="slider-details-container">
                                ...
                                <div class="slider-description">
                                    <div class="subtitile"><?php the_content(); ?></div>
        ...
        <?php 
                    ...
                    if ( $showdeal == 1 && ( !empty( $deal ) ) ):
                        $discount_percentage  =  absint( 100 - ( ( intval($sale) / intval($regular) ) * 100 ) );
              ?>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="deal-desc col-md-4 col-12 mr-auto text-center">
                        ...
                        <span class="discount">
                            ...
                            <?php echo esc_html($discount_percentage) . esc_html__('% OFF;','theme-name') ?>

                        </span>
                        <?php endif; ?>
                        <h3>
                            <a href="<?php esc_url(get_permalink($deal)); ?>"><?php echo esc_html(get_the_title($deal));?></a>
                        </h3>
                        ...
                        <a href="<?php echo esc_url ('?add-to-cart=' . $deal); ?>"
                            class="add-to-cart"><?php esc_html_e('Add to cart','theme-name'); ?> </a>
                    </div>
                </div>
            </div>
        ...
        <section class="lab-blog">
            ...
            $blog_posts     =      new WP_Query($args);
                ...
                ?>
                        ...
                        <div class="excrpt"><?php the_excerpt(); ?></div>
